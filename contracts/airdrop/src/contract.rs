...
pub fn instantiate(
    ...
    CONFIG.save(
        ...
        &Config {
            ...
            c2x_token: deps.api.addr_canonicalize(&msg.c2x_token)?,
        },
    )?;
...
pub fn claim(
    ...
    Ok(Response::new()
        .add_message(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: deps.api.addr_humanize(&config.c2x_token)?.to_string(),
            funds: vec![],
...
pub fn query_config(deps: Deps, _env: Env) -> StdResult<ConfigResponse> {
    ...
    let resp = ConfigResponse {
        ...
        c2x_token: deps.api.addr_humanize(&state.c2x_token)?.to_string(),
    };
